...
import { attachOutline, sendOutline, homeOutline, personOutline, settingsOutline, chatbubbleOutline, logOutOutline } from 'ionicons/icons';
import '../App.css';
...
const HomePage: React.FC = () => {
  ...
  const menuItems = [
    ...
    { icon: logOutOutline, label: 'Logout' }
  ];
